...
static asn_TYPE_member_t asn_MBR_FCDRequestHeader_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct FCDRequestHeader, lat),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct FCDRequestHeader, Long),
...
static asn_TYPE_tag2member_t asn_MAP_FCDRequestHeader_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* dMax at 298 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* hMax at 299 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* hCur at 300 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* tMaxReq at 301 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* tMaxRep at 302 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* lat at 303 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 } /* long at 306 */
};
